...
const ShadowInitParameters_t ShadowInitParametersDefault = {(char *) AWS_IOT_MQTT_HOST_DEFAULT, AWS_IOT_MQTT_PORT_DEFAULT, NULL, NULL,
															NULL, false, NULL};

const ShadowConnectParameters_t ShadowConnectParametersDefault = {(char *) AWS_IOT_MY_THING_NAME_DEFAULT,
																  (char *) AWS_IOT_MQTT_CLIENT_ID_DEFAULT, 0};
