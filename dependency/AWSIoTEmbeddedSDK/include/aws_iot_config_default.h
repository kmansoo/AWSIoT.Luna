...
/**
 * @file aws_iot_config_default.h
 * @brief AWS IoT specific configuration file
 */

#ifndef SRC_SHADOW_IOT_SHADOW_CONFIG_DEFAULT_H_
#define SRC_SHADOW_IOT_SHADOW_CONFIG_DEFAULT_H_
...
//  
//  2016.9.4, Mansoo Kim(mansoo.kim@icloud.com)
//  If you need to resize tx_buf or rx_buf, you must modify this file and rebuild it.
//
...
//  
//  2016.9.4, Mansoo Kim(mansoo.kim@icloud.com)
//  I'd made following functions because I want to separate between AWS IoT SDK and clients for IoT device.
//  So you must implement following functions in your client application side 
//  because this functions will be called by AWS IoT Client SDK while client is connecting publishing and subscribing with AWS IoT Platform. 
//
const char* aws_iot_mqtt_get_host();
int         aws_iot_mqtt_get_port();
const char* aws_iot_mqtt_get_client_id();
const char* aws_iot_mqtt_get_thing_name();
const char* aws_iot_mqtt_get_root_ca_filename();
const char* aws_iot_mqtt_get_certificate_filename();
const char* aws_iot_mqtt_get_private_key_filename();

#ifdef __cplusplus
}
#endif

#endif /* SRC_SHADOW_IOT_SHADOW_CONFIG_DEFAULT_H_ */
